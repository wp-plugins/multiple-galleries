...
1.	Create new gallery, upload photos and select checkboxes next to photos you want to include in that gallery. If no checkboxes are selected, all photos are included.
...
2. Adds 'include' variable with image IDs
